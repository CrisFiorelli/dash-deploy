...
import dash_core_components as dcc # pip install dash_bootstrap_components
       ...
       dbc.Col([
                dbc.Card(
                    [
                        ...
                        dbc.CardLink("Minerando Dados YouTube webPage", href="https://www.youtube.com/channel/UCZ8gRCp3vixlGVAtplCDd5Q", target='_blank', className ='text-center'),
